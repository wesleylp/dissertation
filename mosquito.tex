...
In the case of finding larvae or pupae, the agents collect them for laboratory analysis.
...
% It is possible to use three types of mechanisms when combating the {\it Aedes aegypti}: mechanical, biological and chemical.
