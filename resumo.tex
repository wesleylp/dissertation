...
O conjunto possui diversos diversos desses objetos em múltiplos cenários:
...
Um detector do tipo Faster Region-based Convolutional Neural Network (Faster R-CNN) é treinado uma pequena base de dados,  e é capaz de encontrar possíveis focos de mosquito de maneira automática.
O modelo gerado atinge uma precisão média (AP) de 49,31 pontos, o que é promissor, indicando que novos e melhores modelos podem ser treinados para este fim.
